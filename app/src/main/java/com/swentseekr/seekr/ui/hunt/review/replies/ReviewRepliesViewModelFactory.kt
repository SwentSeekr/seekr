...
/**
 * Simple [ViewModelProvider.Factory] for creating [ReviewRepliesViewModel] instances
 * with a specific [reviewId].
 *
...
class ReviewRepliesViewModelFactory(
    ...
    /**
     * Creates a new [ReviewRepliesViewModel] for the given [modelClass],
     * preconfigured with [reviewId] and [repository].
     */
