...
/**
 * UI layout constants for Hunt creation/editing screens. Includes paddings, corner radii, heights,
 * widths, and alpha values.
 */
...
/**
 * Test tags for Hunt creation/editing UI elements. Used to identify elements in Compose UI tests.
 */
