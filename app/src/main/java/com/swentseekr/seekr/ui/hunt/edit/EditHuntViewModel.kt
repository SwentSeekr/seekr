...
class EditHuntViewModel(
    ...
    /**
     * Identifier of the hunt currently being edited.
     ...
     *
     * When the user removes an already stored image from the UI,
     * its URL is added here so the repository can delete it from Firebase Storage.
     */
     ...
     *
     * If no hunt has been loaded, an exception is thrown.
     * On failure, an error message is exposed via [setErrorMsg].
     */
