...
fun WelcomeDialog(onContinue: () -> Unit) {
    AlertDialog(
        onDismissRequest = {}, // Pas dismissable
        title = {
            Text(
        ...
        text = {
            Text(
                text = "Thank you for joining Seekr! Let's get started with a quick onboarding to set up your profile."
            )
        },
        confirmButton = {
...
fun ProfileSetupDialog(
    ...
    AlertDialog(
        onDismissRequest = {},
        title = { Text("Complète ton profil") },
        text = {
            Column {
                OutlinedTextField(
                    value = pseudonym,
