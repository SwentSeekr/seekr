...
object RatingConstantsStrings {
  ...
  const val EMPTY = "_EMPTY_"
  const val RATING_CONDITION = "Rating must be between"
  const val AND = "and"
  const val FULL_RATING = "Full Rating"
  const val HALF_RATING = "Half Rating"
...
object RatingConstantsDefault {
  ...
  const val HAS_NO_STAR_HALF: Int = 0
}
