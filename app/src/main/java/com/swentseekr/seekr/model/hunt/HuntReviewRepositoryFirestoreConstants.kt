...
object HuntReviewRepositoryFirestoreConstantsStrings {
  ...
  const val TAG = "HuntReviewRepositoryFirestore"
  const val ERROR_MSG = "Error converting document to HuntReview"
}
