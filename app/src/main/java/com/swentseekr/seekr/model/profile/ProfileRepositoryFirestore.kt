  ...
  private suspend fun createDefaultProfile(userId: String): Profile {
    val defaultProfile =
        Profile(
            ...
            author =
                Author(
                    ProfileRepositoryConstants.DEFAULT_USER_NAME,
                    ProfileRepositoryConstants.DEFAULT_USER_BIO,
                    ProfileRepositoryConstants.DEFAULT_PROFILE_PICTURE,
                    ProfileRepositoryConstants.DEFAULT_REVIEW_RATE,
  ...
  private suspend fun documentToProfile(document: DocumentSnapshot): Profile? {
    ...
    val author =
        Author(
            ...
            bio = authorMap["bio"] as? String ?: ProfileRepositoryConstants.DEFAULT_USER_BIO,
            profilePicture =
                (authorMap["profilePicture"] as? Long
                        ?: ProfileRepositoryConstants.DEFAULT_PROFILE_PICTURE.toLong())
                    .toInt(),
            reviewRate =
                authorMap["reviewRate"] as? Double
                    ?: ProfileRepositoryConstants.DEFAULT_REVIEW_RATE,
            sportRate =
                authorMap["sportRate"] as? Double ?: ProfileRepositoryConstants.DEFAULT_SPORT_RATE,
    ...
    val likedHunts =
        db.collection("users")
            .document(uid)
            .collection(ProfileRepositoryConstants.PROFILE_FIELD_LIKED_HUNTS)
            .get()
            .await()
            .documents
            .mapNotNull { documentToHunt(it) }
