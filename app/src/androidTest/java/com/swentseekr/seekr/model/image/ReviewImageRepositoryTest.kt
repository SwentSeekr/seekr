 ...
 *
 * This test suite verifies upload and deletion of review images, ensuring correct URL generation,
 * safe deletion behavior, and proper error handling when interacting with the Firebase Storage
 * emulator.
 */
