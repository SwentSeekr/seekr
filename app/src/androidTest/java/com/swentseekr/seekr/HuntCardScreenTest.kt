 ...
 * com.swentseekr.seekr.ui.components.HuntCardScreen import
 * com.swentseekr.seekr.ui.components.HuntCardScreenTestTags import org.junit.Rule import
 * org.junit.Test import org.junit.runner.RunWith
 *
 * @RunWith(AndroidJUnit4::class) class HuntCardScreenTest {
 *
 * @get:Rule val composeRule = createComposeRule()
 *
 * @Test fun displaysAllHuntCardScreenElements() { composeRule.setContent { HuntCardScreen(onGoBack
 *   = {}) }
 *
 ...
 * .assertIsDisplayed() }
 *
 * @Test fun titleAndAuthorAndDescription_areDisplayed() { composeRule.setContent { HuntCardScreen()
 *   }
 *
 * composeRule.onNodeWithTag(HuntCardScreenTestTags.TITLE_TEXT).assertIsDisplayed()
 * composeRule.onNodeWithTag(HuntCardScreenTestTags.AUTHOR_TEXT).assertIsDisplayed()
