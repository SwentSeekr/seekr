 ...
 *
 * This test suite verifies that deep links containing hunt IDs
 * navigate correctly to the HuntCardScreen, both from app launch
 * and while the app is running. It also checks that the hunt ID
 * is removed from the intent after navigation to prevent repeated
 * navigation on subsequent launches.
 */
