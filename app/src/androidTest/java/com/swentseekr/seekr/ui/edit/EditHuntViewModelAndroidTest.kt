 ...
 *
 * This test suite verifies the functionality of loading, editing, and submitting
 * hunts using the EditHuntViewModel, in conjunction with a Firestore-backed
 * HuntsRepository and Firebase Authentication.
 */
