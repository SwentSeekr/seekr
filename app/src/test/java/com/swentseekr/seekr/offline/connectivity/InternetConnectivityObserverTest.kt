...
class InternetConnectivityObserverTest {
    ...
    fun initial_online_when_network_valid() {
        ...
        every { mockConnectivityManager.getNetworkCapabilities(mockNetwork) } returns networkCapabilities
    ...
    fun start_registers_callback_and_updates_state() {
        ...
        verify(exactly = 1) {
            mockConnectivityManager.registerNetworkCallback(any<NetworkRequest>(), any<ConnectivityManager.NetworkCallback>())
        }
