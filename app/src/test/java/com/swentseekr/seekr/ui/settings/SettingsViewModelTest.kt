 ...
 *
 * This test suite verifies permission handling, toggle requests,
 * sign-out functionality, and state updates by mocking the
 * authentication repository and Android context interactions.
 */
